...
import { ArrowRight, FileCheck, Building2 } from "lucide-react";
      ...
      <div>
        <div className="flex items-center justify-between mb-4 pb-3 border-b border-zinc-100 dark:border-zinc-800">
          <div className="flex items-center gap-2">
            <FileCheck className="w-5 h-5 text-teal-600 dark:text-purple-400" />
            ...
            {applications.map((application) => (
              ...
              >
                <div className="flex items-center gap-3 overflow-hidden">
                  <div className="w-9 h-9 rounded-lg bg-zinc-200/60 dark:bg-zinc-800 flex items-center justify-center text-zinc-600 dark:text-zinc-400 shrink-0">
