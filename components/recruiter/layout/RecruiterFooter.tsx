    ...
    <footer className="mt-auto border-t border-zinc-200 dark:border-zinc-800/80 bg-white/60 dark:bg-zinc-950/60 backdrop-blur-md py-6 px-6 md:px-8">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-zinc-500 dark:text-zinc-400">
        ...
        <nav className="flex flex-wrap justify-center gap-x-6 gap-y-2">
          <Link href="/recruiter/dashboard" className="hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors">
            Dashboard
          </Link>
          <Link href="/recruiter/jobs" className="hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors">
            My Jobs
          </Link>
          <Link href="/recruiter/jobs/create" className="hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors">
            Post Job
          </Link>
          <Link href="/recruiter/applications" className="hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors">
            Applications
          </Link>
        </nav>
